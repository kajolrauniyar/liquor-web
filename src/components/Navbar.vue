     ...
     <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <form class="form-inline my-2 my-lg-0">
            ...
            <a class="btn btn-outline-success my-2 my-sm-0 mx-1" data-toggle="modal" data-target="#login" >Get Start</a>
            <a class="btn btn-outline-info my-2 my-sm-0 mx-1" data-toggle="modal" data-target="#miniCart" >Cart</a>
          </form>
        </div>        
     </div>
</nav>
